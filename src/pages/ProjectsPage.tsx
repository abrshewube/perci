    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            {[
              { icon: Rocket, label: 'Projects', value: '6+', color: 'primary' },
              { icon: Star, label: 'Technologies', value: '20+', color: 'accent' },
              { icon: Code2, label: 'Lines of Code', value: '50K+', color: 'primary' },
              { icon: Sparkles, label: 'Innovation', value: '100%', color: 'accent' }
            ].map((stat, index) => (
              <motion.div
                key={index}
